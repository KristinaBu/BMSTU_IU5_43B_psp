...
/**
 * Класс StocksController представляет собой контроллер, который обрабатывает запросы к ресурсу /stocks
 * и делегирует их обработку сервису StocksService. Это сетевой слой
 * Методы передаютсяя в express.router
 */
